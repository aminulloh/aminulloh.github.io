...
In Chapter 4, Newport introduces a practice called *Solitude Deprivation*: A state in which you spend close to zero time alone with your own thoughts and free from input from other minds.
